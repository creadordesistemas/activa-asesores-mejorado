...
export const metadata = {
  title: 'Tarifas de Luz de TotalEnergies más Baratas | Activa',
  description:
    'Optimiza tu recibo eléctrico con los planes de TotalEnergies. Comparamos tarifas y realizamos tus trámites y altas sin coste. ¡Llámanos ya!',
};
...
const tariffs = [
  { title: 'Tarifa Ahorro', desc: 'Tarifa estable de precio fijo por el kWh consumido las 24h. Perfecta para quienes buscan tranquilidad e importes regulares.' },
  { title: 'Tarifa Programa', desc: 'Discriminación horaria en tres franjas. Te permite ahorrar de forma sustancial si desplazas tus consumos a la noche y madrugada.' },
  { title: 'Tarifa Mini', desc: 'Especialmente diseñada para segundas residencias o viviendas de muy bajo consumo de electricidad.' },
];

const extraServices = [
  { name: 'Facilita Luz', desc: 'Servicio de mantenimiento rápido de tu instalación eléctrica y reparaciones de electrodomésticos importantes.' },
  { name: 'Placas Solares TotalEnergies', desc: 'Estudios de viabilidad técnica y montaje completo de paneles fotovoltaicos.' },
  { name: 'Asistencia 24h', desc: 'Teléfono de urgencias técnicas directas con operarios oficiales a domicilio.' },
];

export default function TotalEnergiesLuzPage() {
  return (
    <>
      {/* Hero */}
          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 sm:gap-6 mb-6">
              ...
              <div className="shrink-0">
                <Image
                  src="/companias/logo-totalenergies.webp"
                  alt="TotalEnergies"
                  width={200}
                  height={112}
            ...
            <p className="text-lg sm:text-xl text-neutral-500 leading-relaxed max-w-3xl">
              Explora las tarifas eléctricas y servicios de TotalEnergies. En Activa Asesores evaluamos de forma independiente tu factura de TotalEnergies y realizamos tus trámites gratis.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 bg-neutral-50 border-b border-neutral-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <div className="section-tag">TotalEnergies España</div>
            <h2 className="section-title">¿Por qué elegir TotalEnergies para tu suministro?</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: 'Precios Competitivos', desc: 'Tarifas transparentes y competitivas frente a las grandes distribuidoras.' },
              { title: 'Programa de Puntos', desc: 'Acumula puntos canjeables por regalos y descuentos directos en energía.' },
              { title: 'Energía Limpia', desc: 'Compromiso firme con la transición hacia fuentes renovables y de bajas emisiones.' },
              { title: 'Sencillez y Claridad', desc: 'Facturas didácticas sin letra pequeña ni sorpresas inesperadas en el cobro.' },
            ].map(b => (
      ...
      <section className="py-20 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Tariffs */}
            <div>
              <h2 className="text-2xl font-bold text-neutral-900 mb-6">Tarifas de TotalEnergies Destacadas</h2>
            ...
            {/* Extra Services */}
            <div>
              <h2 className="text-2xl font-bold text-neutral-900 mb-6">Servicios Adicionales de TotalEnergies</h2>
              <div className="space-y-4">
                {extraServices.map(s => (
      ...
      <section className="py-20 px-4 md:px-8 bg-neutral-50 border-t border-neutral-100">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-neutral-900 mb-6">¿Cómo contratar o gestionar tu tarifa de TotalEnergies?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left mt-10">
            <div className="bg-white p-6 rounded-2xl border border-neutral-100">
              ...
              <p className="text-neutral-500 text-xs">Revisamos tu factura de TotalEnergies para comprobar que no pagues excesos de potencia contratada.</p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-neutral-100">
              ...
              <p className="text-neutral-500 text-xs">Cruzamos tus consumos con el resto de ofertas vigentes en el mercado para recomendarte lo mejor.</p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-neutral-100">
              <span className="text-brand-600 font-bold text-lg block mb-2">03</span>
              <h4 className="font-bold text-neutral-900 text-sm mb-1">Hacemos los trámites</h4>
              <p className="text-neutral-500 text-xs">Gestionamos tu alta de luz o cambio de titularidad en TotalEnergies de forma 100% gratuita para ti.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 md:py-16 px-4 md:px-8 bg-neutral-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">¿Quieres saber si tu tarifa de TotalEnergies es la mejor?</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/contacto" className="btn-primary w-full sm:w-auto justify-center">
              <ZapIcon size={16} />
              Revisar factura de TotalEnergies gratis
            </Link>
