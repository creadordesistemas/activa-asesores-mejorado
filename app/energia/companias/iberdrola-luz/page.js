...
export const metadata = {
  title: 'Tarifas de Luz de Iberdrola más Baratas | Activa Asesores',
  description:
    'Compara los planes de luz de Iberdrola (Plan Online, Estable, Tres Periodos) y ahorra en tu factura. Gestión gratuita de trámites y cambios.',
};
...
const tariffs = [
  { title: 'Plan Estable', desc: 'Mismo precio por kWh las 24 horas del día. Aporta tranquilidad a largo plazo sin importar a qué hora uses tus electrodomésticos.' },
  { title: 'Plan Noche', desc: 'Precios rebajados en horas nocturnas e invierno por las mañanas. Excelente si realizas el 60% de tu consumo en esa franja.' },
  { title: 'Plan Elige 8 Horas', desc: 'Permite seleccionar las 8 horas diarias en las que la electricidad te saldrá notablemente más barata.' },
];

const extraServices = [
  { name: 'Protección Eléctrica Hogar', desc: 'Servicio de reparación de electrodomésticos y urgencias en tu red eléctrica interior.' },
  { name: 'Instalaciones Solares Iberdrola', desc: 'Asesoramiento y montaje de paneles fotovoltaicos con fórmulas de pago flexibles.' },
  { name: 'Urgencias Eléctricas 24h', desc: 'Asistencia inmediata en menos de 3 horas para cortes accidentales de luz en tu propiedad.' },
];

export default function IberdrolaLuzPage() {
  return (
    <>
      {/* Hero */}
          ...
          <div className="max-w-4xl">
            <div className="flex items-center gap-4 sm:gap-6 mb-6">
              ...
              <div className="shrink-0">
                <Image
                  src="/companias/logo-iberdrola.webp"
                  alt="Iberdrola"
                  width={200}
                  height={112}
            ...
            <p className="text-lg sm:text-xl text-neutral-500 leading-relaxed max-w-3xl">
              Explora las tarifas eléctricas y servicios de Iberdrola. En Activa Asesores analizamos de forma independiente tu factura de Iberdrola y gestionamos tus trámites sin coste alguno.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 md:px-8 bg-neutral-50 border-b border-neutral-100">
        <div className="max-w-6xl mx-auto">
          <div className="text-center mb-14">
            <div className="section-tag">Iberdrola España</div>
            <h2 className="section-title">¿Por qué elegir Iberdrola para tu suministro?</h2>
          </div>

          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {[
              { title: 'Planes a tu Medida', desc: 'Amplia variedad de tarifas flexibles que se adaptan a horarios específicos de consumo.' },
              { title: 'Gran Infraestructura', desc: 'Mayor red de distribución y soporte técnico comercial directo en todo el país.' },
              { title: 'Líder en Renovables', desc: 'Mix energético fuertemente enfocado en energía eólica, hidráulica y solar.' },
              { title: 'Aplicación Móvil', desc: 'Seguimiento exacto de curvas de consumo y facturas digitales inmediatas.' },
            ].map(b => (
      ...
      <section className="py-20 px-4 md:px-8 bg-white">
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-2 gap-12">
            {/* Tariffs */}
            <div>
              <h2 className="text-2xl font-bold text-neutral-900 mb-6">Tarifas de Iberdrola Destacadas</h2>
            ...
            {/* Extra Services */}
            <div>
              <h2 className="text-2xl font-bold text-neutral-900 mb-6">Servicios Adicionales de Iberdrola</h2>
              <div className="space-y-4">
                {extraServices.map(s => (
      ...
      <section className="py-20 px-4 md:px-8 bg-neutral-50 border-t border-neutral-100">
        <div className="max-w-4xl mx-auto text-center">
          <h2 className="text-3xl font-bold text-neutral-900 mb-6">¿Cómo contratar o gestionar tu tarifa de Iberdrola?</h2>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-left mt-10">
            <div className="bg-white p-6 rounded-2xl border border-neutral-100">
              ...
              <p className="text-neutral-500 text-xs">Evaluamos tu factura de Iberdrola para ver si el plan contratado encaja con tus horas reales de consumo.</p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-neutral-100">
              ...
              <p className="text-neutral-500 text-xs">Revisamos si existen opciones más competitivas en Iberdrola o en el mercado general para proponerte un cambio.</p>
            </div>
            <div className="bg-white p-6 rounded-2xl border border-neutral-100">
              ...
              <p className="text-neutral-500 text-xs">Nosotros gestionamos el alta o el cambio de titularidad en Iberdrola de forma ágil y 100% gratuita.</p>
            </div>
          </div>
        </div>
      </section>
      ...
      <section className="py-10 md:py-16 px-4 md:px-8 bg-neutral-900 text-white">
        <div className="max-w-3xl mx-auto text-center">
          <h2 className="text-3xl font-bold mb-4">¿Quieres saber si tu tarifa de Iberdrola es la mejor?</h2>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link href="/contacto" className="btn-primary w-full sm:w-auto justify-center">
              <ZapIcon size={16} />
              Revisar factura de Iberdrola gratis
            </Link>
